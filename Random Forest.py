...
precision_train_rf, recall_train_rf, f1_score_train_rf, _ = precision_recall_fscore_support(y_train, y_pred_train_rf, average='weighted')
precision_test_rf, recall_test_rf, f1_score_test_rf, _ = precision_recall_fscore_support(y_test, y_pred_test_rf, average='weighted')
